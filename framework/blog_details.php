...
<body class="tt-magic-cursor digital-agency">
    ...
    <div class="news-insight-details-page mb-130">
        <div class="container">
            <div class="details-content-wrap">
                <div class="post-thumb mb-70">
                    <img src="<?=base_url()?>assets/img/innerpages/news-insight-thumb-img.jpg" alt="">
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        ...
                        <blockquote>
                            <svg width="28" height="127" viewBox="0 0 28 127" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M23 10L27.7735 0H16.2265L21 10H23ZM22 52L22.725 52.6888L23 52.3993V52H22ZM3 72L2.275 71.3112L0.670689 73H3V72ZM22 72H23V71H22V72ZM21 117L16.2265 127H27.7735L23 117H21ZM21 9V52H23V9H21ZM21.275 51.3112L2.275 71.3112L3.725 72.6888L22.725 52.6888L21.275 51.3112ZM3 73H22V71H3V73ZM21 72V118H23V72H21Z"/>
                            </svg>
                            <div class="content">
                            ...
                            <svg class="quote" width="100" height="74" viewBox="0 0 100 74" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="col-xl-8 col-lg-10">
                        ...
                        <div class="tag-and-social-area">
                            <div class="tag-area">
                                <h6>Tag:</h6>
                                <ul class="tag-list">
                                    <li><a href="news-insight-grid.html">Custom</a></li>
                                    <li><a href="news-insight-grid.html">Responsive</a></li>
                                </ul>
                            </div>
                            <div class="social-area">
                                ...
                                <ul class="social-list">
                                    ...
                                    <li><a href="https://www.youtube.com/"><i class="bi bi-twitter-x"></i></a></li>
                    ...
                    <div class="col-xl-8 col-lg-10">
                        <div class="comment-and-form-area">
                                    ...
                                    <li>
                                        <div class="single-comment-area">
                                            <div class="author-img">
                                                <img src="<?=base_url()?>assets/img/innerpages/comment-author-01.jpg" alt="">
                                            </div>
                                        ...
                                        <ul class="comment-replay">
                                            <li>
                                                <div class="single-comment-area">
                                                    <div class="author-img">
                                                        <img src="<?=base_url()?>assets/img/innerpages/comment-author-02.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="comment-content">
                                                        <div class="author-name-deg">
                            ...
                            <div class="inquiry-form">
                                <h2 class="comment-title">Leave Your Comment:</h2>
                                <form class="form-wrap">
                                    ...
                                    <div class="form-inner">
                                        <button type="submit" class="primary-btn3 two btn-hover">
                                            Post Comment
                    ...
                    <div class="col-xl-8 col-lg-10">
                        <div class="details-pagination">
                            <div class="single-pagination">
                                <a class="pagination-btn" href="news-insight-details.html">
                                    <img src="<?=base_url()?>assets/img/innerpages/details-pagination-btn-bg1.png" alt="">
                                ...
                                <div class="content">
                                    <h6><a href="news-insight-details.html">Branding in the Digital Age Key Elements to Consider.</a></h6>
                                </div>
                            </div>
                            <div class="single-pagination two text-end">
                                <div class="content">
                                    <h6><a href="news-insight-details.html">Essential Social Media Strategies for-2024.</a></h6>
                                </div>
                                <a class="pagination-btn" href="news-insight-details.html">
                                    <img src="<?=base_url()?>assets/img/innerpages/details-pagination-btn-bg2.png" alt="">
                                    <div class="btn-content">
                                        Next
                                        <svg width="7" height="14" viewBox="0 0 8 13"
                                            xmlns="http://www.w3.org/2000/svg">
