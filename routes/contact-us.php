                        ...
                        <ul class="contact-list">
                            ...
                            <li>
                                ...
                                <div class="content">
                                    ...
                                    <h6><a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#5b32353d341b3e233a362b373e75383436"><span class="__cf_email__" data-cfemail="c5acaba3aa85a0bda4a8b5a9a0eba6aaa8">[email&#160;protected]</span></a></h6>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="single-contact two">
                        ...
                        <ul class="contact-list">
                            ...
                            <li>
                                ...
                                <div class="content">
                                    <span>Send Us Mail</span>
                                    <h6><a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#3950575f56795c41585449555c175a5654"><span class="__cf_email__" data-cfemail="fb92959d94bb9e839a968b979ed5989496">[email&#160;protected]</span></a></h6>
                                </div>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="single-contact three">
                        ...
                        <ul class="contact-list">
                            ...
                            <li>
                                ...
                                <div class="content">
                                    <span>Send Us Mail</span>
                                    <h6><a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#e28b8c848da2879a838f928e87cc818d8f"><span class="__cf_email__" data-cfemail="0a63646c654a6f726b677a666f24696567">[email&#160;protected]</span></a></h6>
                                </div>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" id="contactCheck1">
                                            ...
                                            <li>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" id="contactCheck2">
                                            ...
                                            <li>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" id="contactCheck3">
                                            ...
                                            <li>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" id="contactCheck4">
                                            ...
                                            <li>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" id="contactCheck5">
                                                    <label class="form-check-label" for="contactCheck5">
                                                        Technical Support
                                                    </label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" id="contactCheck6">
                                                    <label class="form-check-label" for="contactCheck6">
                                                        DevOps Services
                                                    </label>
                                                </div>
                                            </li>
