...
<body class="tt-magic-cursor digital-agency">
    ...
    <div class="about-page-banner-section mb-130">
        <div class="slider-area mb-70">
            <div class="swiper about-page-banner-slider">
                ...
                <div class="row gy-4 justify-content-between">
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="banner-content">
                            ...
                            <a href="contact.html" class="primary-btn3 transparent three btn-hover">
                                Start The Journey
    ...
    <div class="about-page-counter-section">
        <div class="container">
    ...
    <div class="about-page-feature-section mb-130">
        <div class="container">
                    ...
                    <div class="single-feature">
                        ...
                        <p>
                            <svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path
                                        d="M13.5263 8.297C10.5619 6.97028 8.38276 4.27662 7.77418 1C7.16559 4.27662 4.98647 6.97028 2.02207 8.297C1.45275 8.55833 0 8.96037 0 8.96037C0 8.96037 1.43312 9.36241 2.02207 9.62373C4.98647 10.9505 7.16559 13.6642 7.77418 16.9207C8.38276 13.6441 10.5619 10.9505 13.5263 9.62373C14.0956 9.36241 15.5484 8.96037 15.5484 8.96037C15.5484 8.96037 14.1152 8.55833 13.5263 8.297Z"/>
                                    <path
                                        d="M20.8023 15.9137C19.0355 15.1297 17.7594 13.5216 17.3864 11.5918C17.033 13.5216 15.7373 15.1297 13.9705 15.9137C13.6367 16.0745 12.7729 16.2957 12.7729 16.2957C12.7729 16.2957 13.6171 16.5369 13.9705 16.6776C15.7373 17.4616 17.0134 19.0697 17.3864 20.9995C17.7594 19.0898 19.0355 17.4817 20.8023 16.6977C21.1361 16.5369 21.9999 16.3158 21.9999 16.3158C21.9999 16.3158 21.1361 16.0745 20.8023 15.9137Z"/>
                                </g>
                            </svg>
            ...
            <div class="row justify-content-center wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="col-xl-8 col-lg-10">
                    <div class="contact-btn-area two">
                        ...
                        <a href="contact.html" class="primary-btn3 two btn-hover">
                            Start The Journey
                            <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 9L9 1M9 1C7.22222 1.33333 3.33333 2 1 1M9 1C8.66667 2.66667 8 6.33333 9 9" stroke-width="1.5" stroke-linecap="round"></path>
                            </svg>
    ...
    <div class="about-page-team-section mb-130">
        <div class="container">
            <div class="row align-items-lg-end mb-70">
                <div class="col-lg-4">
            ...
            <div class="team-slider-area mb-50">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="swiper about-page-team-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                ...
                <div class="slider-btn-grp three">
                    <div class="slider-btn about-page-team-slider-prev">
                    ...
                    <div class="slider-btn about-page-team-slider-next">
                        <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                            <g>
    ...
    <div class="about-page-gallery-section mb-130">
        <div class="container">
            <div class="row mb-70">
                <div class="col-lg-12">
            ...
            <div class="gallery-img-wrap">
                <div class="row g-2">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="row g-2">
                            <div class="col-md-12 d-lg-flex d-none align-items-center gap-5">
    ...
    <div class="award-list-section mb-130">
        <div class="container">
            <div class="row justify-content-center mb-70 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="col-lg-5">
                    <div class="section-title three">
                        ...
                        <table class="award-table two">
                            <tbody>
                                ...
                                <tr class="wow animate fadeInLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
                                    <td>
                                        <a href="#">Digital Vanguard</a>
                                    </td>
                                    <td>Adobe Platform</td>
                                ...
                                <tr class="wow animate fadeInLeft" data-wow-delay="800ms" data-wow-duration="1500ms">
                                    ...
                                    <td>Behance Platform</td>
                                    <td><span>2021</span></td>
                                </tr>
                                <tr class="wow animate fadeInLeft" data-wow-delay="800ms" data-wow-duration="1500ms">
                                    <td>
                                        <a href="#">Digital Dynamo</a>
                                    </td>
                                    <td>Linkedin Platform</td>
    ...
    <div class="about-page-testimonial-section">
        <div class="container">
            <div class="row justify-content-center mb-70 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="col-lg-5">
                    <div class="section-title three">
        ...
        <div class="scroll-text">
            <a href="contact.html">
                ...
                <svg width="33" height="33" viewBox="0 0 33 33" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 31L30 3M30 3C23.7778 4.16667 10.1667 6.5 2 3M30 3C28.8333 8.83333 26.5 21.6667 30 31" stroke-width="4" stroke-linecap="round" />
                </svg>
            </a>
            <svg width="50" height="50" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M24.1624 12.3939L25 13.6783L25.8376 12.3939L31.633 3.50696L31.3462 14.3464L31.307 15.8289L32.6961 15.3096L42.4498 11.6632L36.083 20.3473L35.2536 21.4786L36.5936 21.8938L46.6206 25L36.5936 28.1062L35.2536 28.5214L36.083 29.6527L42.4498 38.3368L32.6961 34.6904L31.307 34.1711L31.3462 35.6536L31.633 46.493L25.8376 37.6061L25 36.3217L24.1624 37.6061L18.367 46.493L18.6538 35.6536L18.693 34.1703L17.3035 34.6906L7.56551 38.3368L13.9176 29.6518L14.7448 28.5208L13.4064 28.1062L3.37938 25L13.4064 21.8938L14.7448 21.4791L13.9176 20.3482L7.56551 11.6632L17.3035 15.3094L18.693 15.8297L18.6538 14.3464L18.367 3.50697L24.1624 12.3939Z" stroke-width="2" />
            </svg>
            <a href="contact.html">
                Contact
                <svg width="33" height="33" viewBox="0 0 33 33" xmlns="http://www.w3.org/2000/svg">
